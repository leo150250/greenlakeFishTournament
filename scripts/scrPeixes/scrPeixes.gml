...
array_push(global.peixes,new Peixe("Lambari",sprPeixeTeste_icone,sprLambari,50,"Pequeno, rápido e cheio de energia, é a diversão dos pescadores iniciantes. Fácil de pegar e sempre em cardume, o lambari é o peixe que chega chegando em qualquer lago ou rio!",new Comportamento(0,1)));
